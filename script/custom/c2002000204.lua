...
function s.initial_effect(c)
	...
	e0:SetTarget(aux.TargetBoolFunction(Card.IsType,TYPE_GEMINI))
	e0:SetCode(EFFECT_GEMINI_STATUS)
	c:RegisterEffect(e0)
	--Your Gemini Monsters cannot be targeted or destroyed by either player's card effects
