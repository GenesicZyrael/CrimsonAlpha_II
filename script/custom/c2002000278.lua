-- Elemental HERO's Dirge of Darkness
local s,id=GetID()
local alias=89252153 -- Elemental HERO Necroshade
function s.initial_effect(c)
    -- This card's name becomes "Elemental HERO Necroshade" while in hand, Deck, or on the field.
    ...
    e1:SetValue(alias)
    c:RegisterEffect(e1)
    -- Reveal 1 Fusion Monster; Special Summon from GY, then you can add 1 non-DARK "Elemental HERO"
...
function s.spop(e,tp,eg,ep,ev,re,r,rp)
    ...
    if c:IsRelateToEffect(e) and Duel.SpecialSummon(c,0,tp,tp,false,false,POS_FACEUP)~=0 then
        ...
        if Duel.IsExistingMatchingCard(aux.NecroValleyFilter(s.thfilter),tp,LOCATION_DECK+LOCATION_GRAVE,0,1,nil) 
...
-- ==========================================
-- Effect 3: Grant Target Immunity
-- ==========================================
