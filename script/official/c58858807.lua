...
function s.initial_effect(c)
	...
	e2:SetCost(aux.CostWithReplace(Cost.DetachFromSelf(1),CARD_CONSTELLARKNIGHT_TROIVERNUM,nil,s.applycost))
...
-- function s.applycost(e,tp,eg,ep,ev,re,r,rp,chk)
	...
	-- if chk==0 then return Duel.IsExistingMatchingCard(s.rmvfilter,tp,LOCATION_HAND|LOCATION_DECK,0,1,nil,tp) end
